			  ...
			  -->
                        ...
                        <div class="span6">
                            ...
                            <form class="form-horizontal qtyFrm">
                                <div class="control-group">
                                    <label class="control-label"><span id="price">$101.00</span></label>
                                    <div class="controls">

                                        <input type="number" class="span1" id="count" placeholder="Qty.">

                                        <button type="submit" class="btn btn-large btn-primary pull-right" value="pay">
                                            Pay
                                            <i class=" icon-pay"></i></button>
                                    </div>
                                </div>
                            </form>
